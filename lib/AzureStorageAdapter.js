...
var AzureStorageAdapter = exports.AzureStorageAdapter = function () {
  ...
  _createClass(AzureStorageAdapter, [{
    ...
    value: function createFile(filename, data) {
      ...
      return new Promise(function (resolve, reject) {
        _this._client.createContainerIfNotExists(_this._container, containerParams, function (cerr, cresult, cresponse) {
          ...
          _this._client.createBlockBlobFromStream(_this._container, filename, stream, data.legnth, function (err, result) {
            if (err) {
              return reject(err);
            }
    ...
    value: function getFileProperties(filename) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        _this3._client.getBlobProperties(_this3._container, filename, function (err, properties) {
          if (err) reject(err);else resolve(Object.assign({ length: properties.contentLength }, properties));
        });
      });
    }
  }, {
    key: 'getFileStream',
    value: function getFileStream(filename, options) {
      var _this4 = this;
      ...
      return new Promise(function (resolve) {
        var stream = _this4._client.createReadStream(_this4._container, filename, {
          rangeStart: start,
          rangeEnd: end
        });
